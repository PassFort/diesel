...
where
    ...
    SelectStatement<F, SelectClause<Selection>, D, W, O, L, Of, G, LC>: Expression,
{
...
where
    ...
    Self: Expression<SqlType = ST>,
    SelectStatement<F, S, D, W, OrderClause<Expr>, L, Of, G, LC>: Expression<SqlType = ST>,
{
...
where
    Self: Expression<SqlType = ST>,
    SelectStatement<F, S, D, W, O, LimitClause<Limit>, Of, G, LC>: Expression<SqlType = ST>,
{
...
where
    Self: Expression<SqlType = ST>,
    SelectStatement<F, S, D, W, O, L, OffsetClause<Offset>, G, LC>: Expression<SqlType = ST>,
{
